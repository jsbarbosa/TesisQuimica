...
\section{Realizaci\'on del experimento}
	...
	\begin{enumerate}
		\item \textbf{Pause}: En la etapa inicial del experimento se busca medir el estado de la línea base por 5 minutos consecutivos.
		\item \textbf{Baseline}: Luego de tener datos sobre el estado sin perturbar del sistema, se realiza una calibración dinámica para realizar un ajuste fino de los parámetros de ganancia y nivel del cero de la señal. Para esto se aplica primero
